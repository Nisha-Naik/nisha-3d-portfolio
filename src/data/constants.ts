...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "MicroDegree",
    description: [
      "Architected 12+ REST API endpoints with Node.js & Express.js; slashed average response time by 30% through connection pooling and structured error handling.",
      "Shipped 3 production apps to AWS EC2 with GitHub Actions CI/CD pipelines, sustaining 99.9% uptime across 500+ concurrent users.",
    ],
    skills: [
      SkillNames.NODEJS,
      SkillNames.EXPRESS,
  ...
  },
  {
    ...
    description: [
      "Developed a real-time financial dashboard (Python + React) consuming live stock streams for 50+ equity symbols at sub-200ms refresh intervals.",
      "Diagnosed and fixed 8 upstream feed discrepancies, lifting data accuracy by 25% and cutting API latency by 40% via async processing.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.JS,
  ...
  },
  {
    ...
    endDate: "Jul 2025",
    title: "Software Engineering Virtual Intern",
    company: "Walmart GlobalTech (Forage)",
    description: [
      "Modelled 5 ERDs for retail inventory and logistics, translating business requirements into 3NF-normalised schemas supporting 1M+ product records.",
      "Accelerated query execution by 35% through strategic indexing and table partitioning across multi-million-row relational datasets.",
    ],
    skills: [
      SkillNames.POSTGRES,
      SkillNames.NODEJS,
